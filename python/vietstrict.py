...
def _vs_onset_to_qn(onset: str) -> str:
    # Critical fix: dd -> đ (orthography-preserving)
    if onset == "dd":
        return "đ"
    return onset
